...
import { FilesystemUnit, FilesystemUnits, type FilesystemBackendType } from '../filesystem-unit-multiple';
...
describe('FilesystemUnit', () => {
  describe('CREATE', () => {
    ...
    it('should throw error with invalid primary backend', () => {
      expect(() => FilesystemUnit.create({
        backends: [{ type: 'memory' }],
        primary: 'node' as FilesystemBackendType
  ...
  describe('Runtime Management', () => {
    ...
    it('should throw error when switching to non-existent backend', () => {
      ...
      expect(() => unit.setPrimary('node' as FilesystemBackendType)).toThrow("Backend 'node' not found");
    });
